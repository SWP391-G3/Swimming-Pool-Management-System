...
<head>
    ...
    <style>
        ...
        .table-service-report tr:last-child td { border-bottom: none; }
        .badge {
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button"
                                            ...
                                            onclick="showServiceReportDetail(
                                                '${fn:escapeXml(r.serviceName)}',
                                                '${fn:escapeXml(r.poolName)}',
...
<script>
    function showServiceReportDetail(serviceName, poolName, reportReason, suggestion, reportDate, status, serviceId, reportId) {
