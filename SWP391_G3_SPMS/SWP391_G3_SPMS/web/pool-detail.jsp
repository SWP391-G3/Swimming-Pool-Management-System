...
<head>
    ...
    <style>
        ...
        @media (max-width: 1100px) {
            ...
            .main, .service-sidebar { max-width: 99vw; }
            .service-sidebar { width:100%; margin-top:32px;}
        }
        @media (max-width: 650px) {
            .main { padding: 12vw 2vw 5vw 2vw;}
        }
        .back-link {
            position: absolute;
            left: 18px; top: 22px;
        ...
        .back-link:hover { background: #1976d2; color: #fff; }
        h2 {
            color: #1769aa;
            text-align: left;
            font-size: 2rem;
        ...
        /* Carousel */
        .carousel-wrap { width: 100%; max-width: 460px; margin: 0 auto 26px auto; position:relative;}
        .carousel-img {
        ...
        .carousel-arrow {
            ...
            background:rgba(22,108,230,0.75); color:white; border:none;
            ...
            z-index:4; transition:.18s;
        }
        .carousel-arrow.left { left:10px; }
        .carousel-arrow.right { right:10px; }
        .carousel-arrow:hover { background:#1252a6; }
        .carousel-dots {
            text-align:center; margin-top:10px;
        }
        .carousel-dot {
            display:inline-block; width:10px; height:10px; border-radius:50%; margin:0 3px;
            background:#b5cdf6; cursor:pointer;
        }
        .carousel-dot.active { background:#1769aa; }
        /* Nút Đặt bể bơi */
        .btn-booking {
        ...
        .btn-booking:hover { background:#1252a6; color:#fff;}
        .info-row { margin-bottom: 17px; font-size: 1.12rem; display: flex; align-items: flex-start; gap: 4px;}
        .info-label { font-weight: 600; color: #1976d2; min-width: 132px; display: inline-block; letter-spacing: 0.2px;}
        .info-value { color: #21293b; font-weight: 500; flex: 1; word-break: break-word;}
        /* Feedback styles */
        .feedback-section { background:#f9fbff; border-radius:14px; margin:36px 0 0 0; padding:18px 18px 10px 18px; box-shadow:0 2px 12px #c5dbfa18;}
        .feedback-title { color:#0d6efd; font-weight:600; margin-bottom:10px; font-size:1.13rem;}
        .feedback-list { list-style:none; padding:0; margin:0; }
        .feedback-item { border-bottom:1px solid #eaf2fa; padding:11px 0 6px 0;}
        .feedback-rating { color:#f8bb24; margin-right:8px; }
        .feedback-empty { color:#888; font-size:1.04rem; margin-bottom:7px;}
        /* Service card */
        .service-title { color: #0d6efd; font-weight:600; text-align:center; margin-bottom:15px; font-size:1.19rem;}
        .service-card { margin-bottom: 22px; display:flex; gap:14px;}
        .service-card img { width:56px; height:56px; object-fit:cover; border-radius:7px; }
        .service-info { flex:1; }
        .service-name { font-weight:600; color:#1976d2; font-size:1.08rem;}
        .service-price { color:#ee6c21; font-weight:600; font-size:1.07rem; }
        .service-status { margin-left:12px; color:#13b25c; font-size:0.99rem; font-weight:600;}
        @media (max-width:900px) {
            .carousel-img { height:135px; }
        }
        @media (max-width:600px) {
            .main { padding: 5vw 1vw 5vw 1vw;}
            .info-label { min-width:80px;}
            .carousel-img { height: 75vw; min-height:100px; }
            .carousel-wrap { max-width:98vw;}
            .btn-booking { margin-left:50px; margin-top:12px; width:100%; font-size:1rem;}
        }
                ...
                <c:choose>
                    <c:when test="${not empty pool.listImageList && fn:length(pool.listImageList) > 0}">
                        ...
                        <script>
                            ...
                            document.addEventListener('DOMContentLoaded', function() { updateDots(); });
                        </script>
                    </c:when>
                    <c:otherwise>
