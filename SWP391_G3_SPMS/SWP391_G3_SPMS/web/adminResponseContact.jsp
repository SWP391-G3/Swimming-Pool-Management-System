        ...
        <div class="flex-1 ml-72 p-6 space-y-8 overflow-y-auto">
            <main class="space-y-6 bg-white p-6 rounded-2xl shadow-lg animate-fade-in">
                ...
                <form method="post" action="adminResponseContact" class="space-y-5">
                    <input type="hidden" name="contact_id" value="${cw.contact_id}" />

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Tên khách hàng</label>
                        <input type="text" value="${cw.customer_name}" disabled
                               class="w-full px-4 py-2 border border-gray-300 bg-gray-100 rounded-xl shadow-sm text-gray-700" />
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Email</label>
                        <input type="text" value="${cw.customer_email}" disabled
                               class="w-full px-4 py-2 border border-gray-300 bg-gray-100 rounded-xl shadow-sm text-gray-700" />
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="response_content" rows="6" required
                                  class="w-full px-4 py-3 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent resize-none"></textarea>
                    </div>

                    <div class="flex justify-end gap-4">
                        <a href="adminViewCustomerContact"
                           class="inline-flex items-center bg-gray-300 hover:bg-gray-400 text-gray-800 font-medium px-5 py-2.5 rounded-xl shadow transition-colors">
                            <i class="fas fa-arrow-left mr-2"></i> Quay lại
                        </a>
                        <button type="submit"
                                class="inline-flex items-center bg-blue-600 hover:bg-blue-700 text-white font-semibold px-6 py-2.5 rounded-xl shadow-md transition-colors">
