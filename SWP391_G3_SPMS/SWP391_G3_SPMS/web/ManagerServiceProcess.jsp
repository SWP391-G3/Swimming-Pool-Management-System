...
<html lang="vi">
    <head>
        ...
        <title>Xử lý báo cáo dịch vụ</title>
                                        ...
                                        <div class="field-group">
                                            <div class="field-row">
                                                ...
                                                <div class="service-image-container">
                                                    <img src="${service.serviceImage}" alt="Dịch vụ" class="service-image">
                                                </div>
                                            </div>
                                            <form method="post" action="ManagerProcessServiceReport">
                                                ...
                                                <div class="field-group">
                                                    ...
                                                    <input type="number" name="quantity" min="1" value="${service.quantity}" class="form-control">
                                                </div>
                                                <div class="field-group">
                                                    <label>Ghi chú xử lý:</label>
                                                    <textarea name="managerNote" maxlength="200" placeholder="Thêm ghi chú xử lý (nếu có)..." class="form-control">${report.managerNote}</textarea>
                                                </div>
                                                <div class="btn-group">
                        ...
                        <div class="report-card">
                            <div class="card-content">
                                <div class="no-service-message">
                                    ...
                                    <p>Dịch vụ bị báo cáo không còn tồn tại trong hệ thống.</p>
                                    <a href="managerListServiceReportServlet" class="btn btn-secondary">
                                        <svg class="btn-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path>
                                        </svg>
