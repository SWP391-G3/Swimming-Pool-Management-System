...
<%@page import="java.util.List, model.admin.Manager, model.customer.User,model.admin.Branch"%>
<!DOCTYPE html>
<html>
    <head>
            ...
            <main class="w-full max-w-full space-y-6 p-5">
                ...
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center bg-white p-6 rounded-lg shadow">
                    ...
                    <a href="adminViewStaffCategory.jsp"
                       class="bg-gray-600 hover:bg-gray-700 text-white px-4 py-2 rounded shadow transition duration-200">
                ...
                <form action="adminFilterManager" method="get" class="bg-white p-6 rounded-lg shadow space-y-4">
                    ...
                    <div class="flex flex-wrap gap-3 pt-2">
                        ...
                        <a href="adminViewManagerList" type="reset"
                        ...
                        <a href="adminAddManager"
                           class="bg-green-600 hover:bg-green-700 text-white font-semibold px-4 py-2 rounded shadow transition duration-200">
                            <i class="fa-solid fa-square-plus mr-1"></i> Thêm mới
                        </a>
                    </div>
                </form>
