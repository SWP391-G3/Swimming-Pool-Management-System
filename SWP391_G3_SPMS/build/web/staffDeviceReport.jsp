...
<html lang="vi">
    <head>
        ...
        <style>
            ...
            .table-device-report tr:last-child td {
                border-bottom: none;
            }
            .badge {
        ...
        <div id="deviceReportDetailModal" class="custom-modal">
            <div class="custom-modal-content">
                ...
                <div class="custom-modal-body">
                    ...
                    <div><b>Ghi chú </b> <span id="modalManagerNote"></span></div>

                </div>
            </div>
        </div>
        <script>
            function showDeviceReportDetail(deviceName, reportReason, suggestion, reportDate, status, deviceId, reportId, managerNote) {
                ...
                document.getElementById('modalManagerNote').innerText = managerNote || '(Không có)';
                let statusLabel = '';
                if (status === 'pending')
