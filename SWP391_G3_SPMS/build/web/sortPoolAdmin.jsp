...
<html>
    <head>
        <title>Kết quả Sắp Xếp Bể Bơi</title>
            ...
            <div class="row">
                ...
                <main class="col-md-10 ms-sm-auto col-lg-10 main-content">
                    <div class="header-bar">
                        <h2 class="fw-bold text-primary">Kết quả sắp xếp</h2>
                        <a href="#"><i class="bi bi-person-circle"></i></a>
                    </div>
                    <% 
                        String key_name = (String) request.getAttribute("key_sort");
                    %>
                    ...
                    <div class="pagination">
                        <% if (currentPage > 1) { %>
                        <a class="btn btn-primary" href="sortPoolAdmin?page=<%= currentPage - 1 %>&sort=<%= sort %>">Previous</a>
                        <% } %>

                        <% for (int i = startPage; i <= endPage; i++) { %>
                        <a class="btn <%= (i == currentPage ? "btn-success" : "btn-secondary") %>" href="sortPoolAdmin?page=<%= i %>&sort=<%= sort %>"><%= i %></a>
                        <% } %>

                        <% if (currentPage < totalPages) { %>
                        <a class="btn btn-primary" href="sortPoolAdmin?page=<%= currentPage + 1 %>&sort=<%= sort %>">Next</a>
                        <% } %>
                    </div>
                </main>
            </div>
