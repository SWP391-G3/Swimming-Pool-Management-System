    ...
    <body class="bg-white min-h-screen font-['Inter'] antialiased">
        ...
        <div class="container mx-auto px-4 py-8">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                ...
                <a href="profile?service=showProfile" class="bg-blue-500 rounded-lg p-6 text-center cursor-pointer hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 block">
                    <div class="flex flex-col items-center">
                        <svg class="w-8 h-8 mb-3 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="LogoutServlet" class="bg-blue-500 rounded-lg p-6 text-center cursor-pointer hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 block">
                    <div class="flex flex-col items-center">
                        <svg class="w-8 h-8 mb-3 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-gray-100 rounded-lg p-6 shadow-sm mb-8 w-full border border-gray-200">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 xl:grid-cols-2 gap-4">
                    <div>
                        ...
                        <div class="font-medium text-gray-900"><%= user != null ? user.getFull_name() : "" %></div>
                    </div>
                    <div>
