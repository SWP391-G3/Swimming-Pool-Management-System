...
<html>
    <head>
        ...
        <link rel="stylesheet" href="./manager-css/managerAddDiscount.css"> <%-- Đường dẫn tới file CSS --%>
        ...
        <div class="form-container">
            ...
            <form method="post" action="ManagerAddDiscountServlet" class="discount-form">
                <div class="form-group">
                    ...
                    <input type="text" id="discount_code" name="discount_code" class="form-control" required maxlength="50" value="${param.discount_code}">
                </div>

                <div class="form-group">
                    <label for="description">Mô tả:</label>
                    <input type="text" id="description" name="description" class="form-control" maxlength="255" value="${param.description}">
                </div>

                <div class="form-group">
                    <label for="discount_percent">Phần trăm giảm (%):</label>
                    <input type="number" id="discount_percent" name="discount_percent" class="form-control" required min="1" max="50" value="${param.discount_percent}">
                </div>

                <div class="form-group">
                    <label for="quantity">Số lượng (1-100):</label>
                    <input type="number" id="quantity" name="quantity" class="form-control" required min="1" max="100" value="${param.quantity}">
                </div>

                <div class="form-group">
                    <label for="valid_from">Ngày bắt đầu:</label>
                    <input type="datetime-local" id="valid_from" name="valid_from" class="form-control" required value="${param.valid_from}">
                </div>

                <div class="form-group">
                    <label for="valid_to">Ngày kết thúc:</label>
                    <input type="datetime-local" id="valid_to" name="valid_to" class="form-control" required value="${param.valid_to}">
                </div>
