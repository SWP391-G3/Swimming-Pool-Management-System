...
<html>
    <head>
        <title>Kết quả lọc theo khu vực</title>
            ...
            <div class="row">
                ...
                <main class="col-md-10 ms-sm-auto col-lg-10 main-content">
                    <div class="header-bar">
                        <h2 class="fw-bold text-primary">Kết quả lọc theo khu vực</h2>
                        <a href="#"><i class="bi bi-person-circle"></i></a>
                    </div>
                    <% 
                        String key_name = (String) request.getAttribute("location");
                    %>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover align-middle">
                            ...
                            <% 
                                ...
                                String pool_address = (String) request.getAttribute("pool_address");
                    ...
                    <div class="pagination">
                        <% if (currentPage > 1) { %>
                        <a class="btn btn-primary" href="locationAdmin?page=<%= currentPage - 1 %>&checkLocation=<%= pool_address %>">Previous</a>
                        <% } %>

                        <% for (int i = startPage; i <= endPage; i++) { %>
                        <a class="btn <%= (i == currentPage ? "btn-success" : "btn-secondary") %>" href="locationAdmin?page=<%= i %>&checkLocation=<%= pool_address %>"><%= i %></a>
                        <% } %>

                        <% if (currentPage < totalPages) { %>
                        <a class="btn btn-primary" href="locationAdmin?page=<%= currentPage + 1 %>&checkLocation=<%= pool_address %>">Next</a>
                        <% } %>
                    </div>
                </main>
            </div>
