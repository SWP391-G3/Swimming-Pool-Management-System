                    ...
                    <div class="mt-6 flex justify-center p-3">
                        <div class="mt-6 flex justify-center items-center space-x-2 text-sm">
                            ...
                            <%
                                ...
                                String baseUrl = "adminFilterContact?page=";
                                if (request.getParameter("keyword") != null) {
                                    baseUrl += "keyword=" + java.net.URLEncoder.encode(request.getParameter("keyword"), "UTF-8") + "&";
                                }
                                if (request.getParameter("status") != null) {
                                    baseUrl += "status=" + request.getParameter("status") + "&";
                                }
                                if (request.getParameter("subject") != null) {
                                    baseUrl += "subject=" + java.net.URLEncoder.encode(request.getParameter("subject"), "UTF-8") + "&";
                                }
                                baseUrl += "page=";
                            %>
