...
<head>
    ...
    <style>
    html, body, .layout, .content-panel { height: 100%; min-height: 100vh; }
    .content-panel {
        padding: 40px 0;
        min-height: 100vh;
        background: #f8fafd;
    ...
    .btn-back:hover { background: #d1c4e9; }
    .form-panel h2 { margin: 0; text-align: left; font-size: 1.45rem;}
    .form-row {
        display: flex;
        gap: 40px;
        margin-bottom: 12px;
    ...
    .form-img-preview {
        display: flex; align-items: center; gap: 15px; margin-top: 7px;
    }
    .form-img-preview img {
        max-width: 120px; max-height: 100px; border-radius: 7px; border: 1px solid #eee;
    }
    .form-actions {
        display: flex; justify-content: flex-end; gap: 12px; margin-top: 36px;
    }
    .btn-save {
        background: #1976d2; color: #fff; border: none;
        padding: 10px 36px; border-radius: 4px; font-weight: bold; font-size: 16px; cursor: pointer;
    }
    .btn-cancel {
        background: #ede7f6; color: #8e24aa; border: none;
        padding: 10px 28px; border-radius: 4px; font-weight: 500; text-decoration: none;
    }
    @media (max-width: 900px) {
        .form-panel { padding: 22px 8vw 22px 8vw; }
    ...
    <div class="content-panel">
        <form class="form-panel" method="post" action="pool-service" autocomplete="off">
            ...
            <div class="form-group" style="margin-bottom: 22px;">
                ...
                <input type="text" name="service_name" id="service_name" value="${isEdit ? fn:escapeXml(poolService.serviceName) : ''}" required maxlength="100"/>
            </div>
            <!-- Row: Giá & Số lượng -->
            <div class="form-row">
                <div class="form-group">
