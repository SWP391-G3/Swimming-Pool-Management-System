            ...
            <div class="row">
                ...
                <main class="col-md-10 ms-sm-auto col-lg-10 main-content">
                    <div class="header-bar">
                        <h2 class="fw-bold text-primary"><%= nameWork %></h2>
                        <a href="#">
                    ...
                    <div class="pagination">
                        <% if (currentPage > 1) { %>
                        <a class="btn btn-primary" href="poolmanagement?page=<%= currentPage - 1 %>">Previous</a>
                        <% } %>

                        <% for (int i = startPage; i <= endPage; i++) { %>
                        <a class="btn <%= (i == currentPage ? "btn-success" : "btn-secondary") %>" href="poolmanagement?page=<%= i %>"><%= i %></a>
                        <% } %>

                        <% if (currentPage < totalPages) { %>
                        <a class="btn btn-primary" href="poolmanagement?page=<%= currentPage + 1 %>">Next</a>
                        <% } %>
                    </div>
                </main>
            </div>
