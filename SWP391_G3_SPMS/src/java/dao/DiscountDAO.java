...
public class DiscountDAO extends DBContext {
    ...
    public List<Discounts> getDiscountByUserID(int userId) throws SQLException {
    ...
    public List<Discounts> getDiscountByUserIDAndStatus(int userId, boolean status) throws SQLException {
        List<Discounts> list = new ArrayList<>();
        String sql = "SELECT d.* FROM Discounts d "
                + "JOIN Customer_Discount cd ON d.discount_id = cd.discount_id "
