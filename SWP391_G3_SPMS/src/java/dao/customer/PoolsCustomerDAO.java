...
public class PoolsCustomerDAO extends DBContext {
    ...
    public PoolsCustomer getPoolById(int poolId) {
        String sql = "SELECT * FROM Pools WHERE pool_id = ?";
        try (PreparedStatement ps = connection.prepareStatement(sql)) {
            ps.setInt(1, poolId);
            ResultSet rs = ps.executeQuery();
            if (rs.next()) {
                PoolsCustomer pool = new PoolsCustomer();
    ...
    public List<PoolsCustomer> getPools(String name, String location, String capacity, String openTime, String closeTime, int page, int pageSize) {
        List<PoolsCustomer> list = new ArrayList<>();
    ...
    public List<PoolsCustomer> getTop3() {
        List<PoolsCustomer> list = new ArrayList<>();
        String sql = "select * \n"
                + "from [dbo].[Pools] \n"
                + "order by pool_id\n"
    ...
    public List<PoolsCustomer> getPoolImage() {
        List<PoolsCustomer> list = new ArrayList<>();
