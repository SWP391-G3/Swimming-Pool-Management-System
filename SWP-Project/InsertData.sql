...
VALUES
('admin', 'admin@123', 'Admin', 'admin@example.com', '0123456789', '123 Admin St', 1, 1, '1980-01-01', 'Male', NULL, GETDATE(), NULL),
('manager1', 'manager@123', 'Manager One', 'manager1@example.com', '0987654321', '456 Manager Rd', 2, 1, '1985-05-15', 'Female', NULL, GETDATE(), NULL),
('staff1', 'staff@123', 'Staff One', 'staff1@example.com', '0912345678', '789 Staff Ln', 3, 1, '1990-07-20', 'Male', NULL, GETDATE(), NULL),
('customer1', 'customer@123', 'Customer One', 'customer1@example.com', '0901234567', '101 Customer Ave', 4, 1, '2000-10-10', 'Female', NULL, GETDATE(), NULL),
('staff2', 'staff2@123', 'Staff Two', 'staff2@example.com', '0912345679', '112 Staff St', 3, 1, '1991-02-02', 'Female', NULL, GETDATE(), NULL),
('staff3', 'staff3@123', 'Staff Three', 'staff3@example.com', '0912345680', '113 Staff St', 3, 1, '1992-03-03', 'Male', NULL, GETDATE(), NULL),
('staff4', 'staff4@123', 'Staff Four', 'staff4@example.com', '0912345681', '114 Staff St', 3, 1, '1993-04-04', 'Female', NULL, GETDATE(), NULL),
('customer2', 'customer2@123', 'Customer Two', 'customer2@example.com', '0901234568', '201 Customer Blvd', 4, 1, '2001-11-11', 'Male', NULL, GETDATE(), NULL),
('customer3', 'customer3@123', 'Customer Three', 'customer3@example.com', '0901234569', '202 Customer Blvd', 4, 1, '2002-12-12', 'Female', NULL, GETDATE(), NULL),
('customer4', 'customer4@123', 'Customer Four', 'customer4@example.com', '0901234570', '203 Customer Blvd', 4, 1, '2003-09-09', 'Male', NULL, GETDATE(), NULL);
...
--Tuấn Anh thêm dữ liệu vào bảng Staff_Assignment

INSERT INTO Staff_Assignment (user_id, pool_id, role, shift_name, assigned_date)
VALUES 
(3, 1, N'Huấn luyện viên', N'Sáng', '2025-06-01'),
(5, 2, N'Giám sát viên', N'Chiều', '2025-06-01'),
(6, 3, N'Nhân viên hỗ trợ', N'Tối', '2025-06-02'),
(7, 4, N'Bảo trì', N'Sáng', '2025-06-03'),
(3, 5, N'Thu ngân', N'Chiều', '2025-06-04'); -- staff1 làm thêm 1 ca


--Tuấn Anh thêm dữ liệu vào bảng Attendance

INSERT INTO Attendance (user_id, pool_id, check_in, check_out, shift_name, note, created_at)
VALUES 
(3, 1, '2025-06-01 06:00:00', '2025-06-01 10:00:00', N'Sáng', N'Đúng giờ', GETDATE()),
(5, 3, '2025-06-02 17:30:00', '2025-06-02 20:00:00', N'Tối', N'Hoàn thành tốt', GETDATE()),
(6, 4, '2025-06-03 06:00:00', '2025-06-03 10:00:00', N'Sáng', N'Tăng ca thêm 30 phút', GETDATE()),
(7, 5, '2025-06-04 13:00:00', '2025-06-04 17:00:00', N'Chiều', N'Làm thay ca', GETDATE());
