        ...
        <div class="content-panel">
            ...
            <div class="dashboard-cards">
                ...
                <a href="feedback-management.jsp" class="dashboard-card">
                   ...
                   <a href="pool-service" class="dashboard-card">
                    <div class="dashboard-card-title">Quản lý dịch vụ</div>
                    <div class="dashboard-card-desc">Quản lý dịch vụ cho thuê phao, áo bơi, kính bơi và các thiết bị hỗ trợ khác.</div>
                </a>
            </div>
        </div>
    </div>
