...
<head>
    ...
    <style>
        ...
        .card {
            border: 1px solid #e1e1e1; border-radius: 8px; padding: 10px; margin-bottom: 15px;
            display: flex; align-items: center; justify-content: space-between; cursor: pointer;
        }
        .card img { height: 50px; width: 50px; border-radius: 4px; object-fit: cover; }
        .card-content { display: flex; align-items: center; gap: 15px; flex-grow: 1; }
        .pagination { margin-top: 20px; text-align: center; }
        .pagination a, .pagination span {
            margin: 0 3px; padding: 6px 12px;
            border: 1px solid #ccc; text-decoration: none; border-radius: 4px;
            color: #333; background: #fff; font-weight: 500;
        }
        .pagination a:hover {
            background: #e3f0fd; color: #1a73e8; border-color: #1a73e8;
        }
        .pagination .active {
        ...
        .pagination .disabled {
            color: #aaa; border-color: #eee; background: #fafafa; pointer-events: none;
        }
        ...
        <table class="table-pool-service">
            ...
            <tbody>
                <c:forEach var="ps" items="${list}">
                    <tr onclick="location.href = 'pool-service?action=edit&id=${ps.poolServiceId}'" style="cursor:pointer;">
