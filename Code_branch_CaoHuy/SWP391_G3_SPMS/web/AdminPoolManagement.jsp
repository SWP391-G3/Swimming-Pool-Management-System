            ...
            <div class="row">
                ...
                <main class="col-md-10 ms-sm-auto col-lg-10 main-content">
                    <div class="header-bar d-flex justify-content-between align-items-center px-4 py-3 shadow-sm rounded bg-white mb-4">
                        <h2 class="fw-bold text-primary mb-0"><%= nameWork %></h2>
                    ...
                    <form action="adminSearchPool" method="GET" class="row g-3 my-3">
                        ...
                        <div class="col-md-4 d-flex align-items-start gap-2">
                            ...
                            <a href="AdminAddPool.jsp" class="btn btn-success"><i class="bi bi-bag-plus"></i> Thêm bể bơi mới</a>
                        </div>
                        ...
                        <table class="table table-bordered table-hover align-middle">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <span class="status"><%= p.isPool_status() ? "Đang hoạt động" : "Hủy hoạt động" %></span>
                                    </td>                                                                  
                                    <td>
